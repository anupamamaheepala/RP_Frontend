...
class G3_L1_Medium_A2 extends StatefulWidget {
  final List<String> sentences;

  const G3_L1_Medium_A2({super.key, required this.sentences});

  @override
  _G3_L1_Medium_A2State createState() => _G3_L1_Medium_A2State();
}

class _G3_L1_Medium_A2State extends State<G3_L1_Medium_A2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Activity 2 - See the Written Word"),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              widget.sentences[_currentRound],
