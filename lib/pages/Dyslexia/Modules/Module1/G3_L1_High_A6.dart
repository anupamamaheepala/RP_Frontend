...
class _G3_L1_ShortPhraseReading_A6State
  ...
  final List<Map<String, String>> _tasks = [
    ...
    },
    {
      'firstWord': 'ගෙදර',
      'secondWord': 'එන්න',
      'fullPhrase': 'ගෙදර එන්න',
      'firstWordMeaning': 'Home',
    ...
    },
    {
      'firstWord': 'පොත',
      'secondWord': 'කියවන්න',
      'fullPhrase': 'පොත කියවන්න',
      'firstWordMeaning': 'book',
      'secondWordMeaning': 'Read',
      'fullMeaning': 'Read the book',
      'firstEmoji': '📚',
      'secondEmoji': '👩‍🏫',
    },
    {
      'firstWord': 'ක්‍රීඩා',
      'secondWord': 'කරන්න',
      'fullPhrase': 'ක්‍රීඩා කරන්න',
      'firstWordMeaning': 'Sport',
      'secondWordMeaning': 'Play',
      'fullMeaning': 'Play the games',
      'firstEmoji': '🏀',
      'secondEmoji': '⛹🏻',
    },
    {
