...
class DyscalSpecialTaskG06Page extends StatefulWidget {
  const DyscalSpecialTaskG06Page({super.key});

  @override
  State<DyscalSpecialTaskG06Page> createState() => _DyscalSpecialTaskG06PageState();
}

class _DyscalSpecialTaskG06PageState extends State<DyscalSpecialTaskG06Page> {
  ...
  Future<void> _fetchSpecialQuestions() async {
    try {
      final qUrl = Uri.parse("${Config.baseUrl}/dyscalculia/learning-questions/6/medium");
          ...
          child: Column(
            children: [
              AppBar(
                ...
                elevation: 0,
                title: const Text('විශේෂ ඇගයීම - 6 ශ්‍රේණිය', style: TextStyle(color: Colors.purple, fontWeight: FontWeight.bold)),
                centerTitle: true,
