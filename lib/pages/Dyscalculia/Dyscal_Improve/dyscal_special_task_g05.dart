...
class DyscalSpecialTaskG05Page extends StatefulWidget {
  ...
  @override
  State<DyscalSpecialTaskG05Page> createState() => _DyscalSpecialTaskG05PageState();
}

class _DyscalSpecialTaskG05PageState extends State<DyscalSpecialTaskG05Page> {
  ...
  Future<void> _fetchSpecialQuestions() async {
    try {
      // Fetching Grade 5 Medium Questions for special task
      final qUrl = Uri.parse("${Config.baseUrl}/dyscalculia/learning-questions/5/medium");
          ...
          child: Column(
            children: [
              AppBar(
                ...
                elevation: 0,
                title: const Text('විශේෂ ඇගයීම - 5 ශ්‍රේණිය', style: TextStyle(color: Colors.purple, fontWeight: FontWeight.bold)),
                centerTitle: true,
